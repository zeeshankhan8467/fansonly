...
} elseif ($_instance->childHasBeenRendered('aQYp45H')) {
    $componentId = $_instance->getRenderedChildComponentId('aQYp45H');
    $componentTag = $_instance->getRenderedChildComponentTagName('aQYp45H');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('aQYp45H');
} else {
    $response = \Livewire\Livewire::mount('notifications-icon');
    $dom = $response->dom;
    $_instance->logRenderedChild('aQYp45H', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </li>
...
} elseif ($_instance->childHasBeenRendered('vtWcVwV')) {
    $componentId = $_instance->getRenderedChildComponentId('vtWcVwV');
    $componentTag = $_instance->getRenderedChildComponentTagName('vtWcVwV');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vtWcVwV');
} else {
    $response = \Livewire\Livewire::mount('unread-messages-count');
    $dom = $response->dom;
    $_instance->logRenderedChild('vtWcVwV', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </li>
...
} elseif ($_instance->childHasBeenRendered('ABtTvfP')) {
    $componentId = $_instance->getRenderedChildComponentId('ABtTvfP');
    $componentTag = $_instance->getRenderedChildComponentTagName('ABtTvfP');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ABtTvfP');
} else {
    $response = \Livewire\Livewire::mount('search-creators');
    $dom = $response->dom;
    $_instance->logRenderedChild('ABtTvfP', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php endif; ?><?php /**PATH /Users/crivion/Sites/patrons/resources/views/partials/topnavi.blade.php ENDPATH**/ ?>