...
} elseif ($_instance->childHasBeenRendered('9JnTnTl')) {
    $componentId = $_instance->getRenderedChildComponentId('9JnTnTl');
    $componentTag = $_instance->getRenderedChildComponentTagName('9JnTnTl');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9JnTnTl');
} else {
    $response = \Livewire\Livewire::mount('notifications-icon');
    $dom = $response->dom;
    $_instance->logRenderedChild('9JnTnTl', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </li>
...
} elseif ($_instance->childHasBeenRendered('cNb8ocm')) {
    $componentId = $_instance->getRenderedChildComponentId('cNb8ocm');
    $componentTag = $_instance->getRenderedChildComponentTagName('cNb8ocm');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cNb8ocm');
} else {
    $response = \Livewire\Livewire::mount('unread-messages-count');
    $dom = $response->dom;
    $_instance->logRenderedChild('cNb8ocm', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </li>
...
} elseif ($_instance->childHasBeenRendered('SdtQ5YF')) {
    $componentId = $_instance->getRenderedChildComponentId('SdtQ5YF');
    $componentTag = $_instance->getRenderedChildComponentTagName('SdtQ5YF');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SdtQ5YF');
} else {
    $response = \Livewire\Livewire::mount('search-creators');
    $dom = $response->dom;
    $_instance->logRenderedChild('SdtQ5YF', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\test\fansonly-patrons-old\resources\views/partials/topnavi.blade.php ENDPATH**/ ?>