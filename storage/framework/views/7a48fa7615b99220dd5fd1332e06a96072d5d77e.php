...
} elseif ($_instance->childHasBeenRendered('8lINi6E')) {
    $componentId = $_instance->getRenderedChildComponentId('8lINi6E');
    $componentTag = $_instance->getRenderedChildComponentTagName('8lINi6E');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8lINi6E');
} else {
    $response = \Livewire\Livewire::mount('message');
    $dom = $response->dom;
    $_instance->logRenderedChild('8lINi6E', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test\fansonly-patrons\resources\views/messages/inbox.blade.php ENDPATH**/ ?>