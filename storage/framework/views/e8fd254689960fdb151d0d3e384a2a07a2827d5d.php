...
} elseif ($_instance->childHasBeenRendered('iCeWihQ')) {
    $componentId = $_instance->getRenderedChildComponentId('iCeWihQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('iCeWihQ');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iCeWihQ');
} else {
    $response = \Livewire\Livewire::mount('notifications-icon');
    $dom = $response->dom;
    $_instance->logRenderedChild('iCeWihQ', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </li>
...
} elseif ($_instance->childHasBeenRendered('XaApDLB')) {
    $componentId = $_instance->getRenderedChildComponentId('XaApDLB');
    $componentTag = $_instance->getRenderedChildComponentTagName('XaApDLB');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XaApDLB');
} else {
    $response = \Livewire\Livewire::mount('unread-messages-count');
    $dom = $response->dom;
    $_instance->logRenderedChild('XaApDLB', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </li>
...
} elseif ($_instance->childHasBeenRendered('uAjiwlq')) {
    $componentId = $_instance->getRenderedChildComponentId('uAjiwlq');
    $componentTag = $_instance->getRenderedChildComponentTagName('uAjiwlq');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uAjiwlq');
} else {
    $response = \Livewire\Livewire::mount('search-creators');
    $dom = $response->dom;
    $_instance->logRenderedChild('uAjiwlq', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\test\new\fansonly-patrons-v1.8.1-null-chintanbhat\resources\views/partials/topnavi.blade.php ENDPATH**/ ?>