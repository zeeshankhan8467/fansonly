...
} elseif ($_instance->childHasBeenRendered('QONFukd')) {
    $componentId = $_instance->getRenderedChildComponentId('QONFukd');
    $componentTag = $_instance->getRenderedChildComponentTagName('QONFukd');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QONFukd');
} else {
    $response = \Livewire\Livewire::mount('followbutton', [ 'profileId' => $profile->id ]);
    $dom = $response->dom;
    $_instance->logRenderedChild('QONFukd', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make( 'welcome' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test\fansonly-patrons\resources\views/profile/user-profile.blade.php ENDPATH**/ ?>