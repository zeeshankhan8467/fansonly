        ...
        <div class="col-md-8">
            <div class="">
                ...
                <div class="card p-3 shadow-sm mb-3">
                    ...
                    <h1 class="text-center"><i class="fa fa-user"></i> <?php echo app('translator')->get( 'navigation.login' ); ?></h1>
                    <div class="text-center mb-3"><?php echo app('translator')->get('auth.signInText'); ?></div><!-- /.text-center -->
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test\fansonly-patrons\resources\views/auth/login.blade.php ENDPATH**/ ?>