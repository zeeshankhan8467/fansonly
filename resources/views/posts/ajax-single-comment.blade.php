<div class="row singleComment mt-2" data-id="{{ $comment->id }}" data-post="{{ $comment->commentable->id }}">
<div class="col-1">
...
<div class="col-11">
	...
	<div class="text-wrap comment-content" data-id="{{  $comment->id }}" data-post="{{  $comment->commentable->id }}">{{ $comment->comment }}</div>
	...
	<a href="javascript:void(0)" class="edit-comment text-secondary" data-id="{{ $comment->id }}">
